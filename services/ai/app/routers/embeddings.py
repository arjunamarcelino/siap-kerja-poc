...
from app.dependencies import get_embedding_service, get_redis_client
from app.models.schemas import EmbedSkillsRequest, EmbedSkillsResponse
from app.services.embedding_service import EmbeddingService
from app.services.job_scraper import ScrapedJob, scrape_glints_jobs
...
async def scrape_jobs(
    ...
    """Scrape job listings from Glints for a given role. Uses Redis cache."""
    return await scrape_glints_jobs(role, redis_client=redis_client)
